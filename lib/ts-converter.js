...
export class TSToMP4Converter {
  ...
  static buildMoov(videoData, audioData, baseMdatOffset = 0, is64Bit = false) {
    ...
    if (videoData) {
      ...
      mdhdView.setUint16(16, 0x55C4); // 'und' language
  ...
  static buildFtyp() {
    ...
    ftypPayload[8] = 0x69; ftypPayload[9] = 0x73; ftypPayload[10] = 0x6F; ftypPayload[11] = 0x6D; // isom
    ftypPayload[12] = 0x69; ftypPayload[13] = 0x73; ftypPayload[14] = 0x6F; ftypPayload[15] = 0x32; // iso2
    ftypPayload[16] = 0x61; ftypPayload[17] = 0x76; ftypPayload[18] = 0x63; ftypPayload[19] = 0x31; // avc1
    ftypPayload[20] = 0x6D; ftypPayload[21] = 0x70; ftypPayload[22] = 0x34; ftypPayload[23] = 0x31; // mp41
